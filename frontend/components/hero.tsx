			...
			>
				<div className="flex flex-col items-center gap-6 text-center">
					...
					<div className="flex gap-4">
						<Link href="/upload" className="inline-flex items-center gap-2 rounded-md bg-gradient-to-r from-red-600 to-rose-700 px-6 py-3 text-sm font-semibold text-white shadow-md transition-transform hover:scale-[1.03] hover:brightness-110">
							Start Analysis
						</Link>
